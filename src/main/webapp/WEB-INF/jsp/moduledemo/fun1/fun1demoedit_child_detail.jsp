...
<script type="text/javascript">
	...
	function FF_ShowDialog(data, isAddNew)
	{
		...
		if (detailWin){
			...
			formdetail.ligerForm({ 
            	fields: [
					{ display: "<span style='color: red;'>*</span>&nbsp字段1", name: "SDdetail_fieldName1", newline: true, labelWidth: 70, width: 240, space: 30, type: "text",
							validate: { required: true, maxlength: 256}},
			        { display: "<span style='color: red;'>*</span>&nbsp字段2", name: "SDdetail_fieldName2", newline: true, labelWidth: 70, width: 240, space: 30, type: "text",
			        	 	validate: { required: true, maxlength: 256}},
	...
	function FF_DetailSave(){
		formdetail.attr("action","${baseURL}/moduledemo/fun1/children/fun1demochildsave/save.do");
