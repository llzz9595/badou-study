...
<div id="detail" style="display:none;">
 	<form id="formdetail" name="formdetail" method="post">
 		<input type="hidden" name="SDdetail_userid" id="SDdetail_userid"  value="${id}"/>
...
<script type="text/javascript">
	...
	function FF_ShowDialog(data, isAddNew)
	{
		...
		if (detailWin){
			...
			formdetail.ligerForm({ 
            	fields: [
					{ display: "<span style='color: red;'>*</span>&nbs爱好", name: "SDdetail_playName", newline: true, labelWidth: 70, width: 240, space: 30, type: "text",
							validate: { required: true, maxlength: 256}},
			        { display: "<span style='color: red;'>*</span>&nbsp描述", name: "SDdetail_playMs", newline: true, labelWidth: 70, width: 240, space: 30, type: "text",
			        	 	validate: { required: true, maxlength: 256}},
			       	{ display: "&nbsp&nbsp&nbsp排序号", name: "SDdetail_priority", newline: true, labelWidth: 70, width: 240, space: 30, type: "int",
			        	 ...
			        	 /* 	{ display: "userid", name: "userid", newline: true, labelWidth: 70, width: 240, space: 30, type: "int",
				        		validate: { required: true, min: 0, max: 99999, digits:true}} */
         		],
		...
		if(curentData)
		{
            ...
            $("#SDdetail_playName").val(curentData.playName);
            $("#SDdetail_playMs").val(curentData.playMs);
            //$("#SDdetail_userid").val(curentData.userid);
	...
	function FF_DetailSave(){
		formdetail.attr("action","${baseURL}/moduledemo/user/children/userdemochildsave/save.do");
