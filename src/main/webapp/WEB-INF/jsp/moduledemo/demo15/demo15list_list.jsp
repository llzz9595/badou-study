...
<div id="container" style="height:400px;margin-right:240px;float:left"></div>  
  ...
  **/
  ...
  $.ajax({
	  url: '${baseURL}/moduledemo/demo15/demo15list/initChart.do',
	  type: 'POST',
	  dataType: 'json',
     ...
     series:json
          ...
          {display:"商品名称",name:"goods",width:100,type:"text",align:"center",isSort : true},
		  ...
		  url: '${baseURL}/moduledemo/demo15/demo15list/initDemo15.do', 
		  sortName: 'goods',
