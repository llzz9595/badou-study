	...
	<body>
	        	...
	        	<form id="formsearch" class="l-form" method="get">
			        <table cellpadding="0" cellspacing="1" class="l-table-edit" >
			            <tr>
			                ...
			                <tr>
			                <td align="right" class="l-table-edit-td"  ltype="text" style="padding-left: 30px">请假天数</td>
			                <td align="left" class="l-table-edit-td" >
								<input type="text" id="days" name="days"  class="field" style=" margin-left:2px;width: 160px" />
			                </td>
			                <td align="right" class="l-table-edit-td"  style="padding-left: 30px">审核状态</td>
			                <td align="left" class="l-table-edit-td" >
			               		 <select name="agreeFlag" id="agreeFlag" class="field">
		...
		<div id="maingrid"></div> 
  		<script type="text/javascript">
  		 $(function ()
  		       {
  		           $("#periodb").ligerDateEditor({ initValue: '2012-03-07' });
  		         $("#periode").ligerDateEditor({ initValue: '2016-03-07' });
  		       });
	      	//列表结构
	      	var grid = $("#maingrid").ligerGrid({ 
				...
				dataAction: 'server',toolbar: {},
	          	url: '${baseURL}/jinhan/holiday/jinhanholidaylistmn/listJSON.do', sortName: 'createTime',
