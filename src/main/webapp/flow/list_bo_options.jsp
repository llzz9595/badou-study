...
<html>
	...
	<%
	try{
	IWorklistService worklistService = (IWorklistService)SpringHelper.getBean("worklistService");
	List listBoOptions = worklistService.listOptions(request.getParameter("id"),request.getParameter("nodeCode"));
