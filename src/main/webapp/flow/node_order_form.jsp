...
parent.buttomFrame.Entrys.form1.action="${ROOT}/sortNode.do1?"+urlPara;
...
if(partment=='exitnode')
 {
    parent.buttomFrame.Entrys.location.href="${ROOT}/flowEditPage.do1?flowCode=<%=request.getParameter("flowCode")%>"+urlPara;
