	...
	<head>
		...
		<script>
			...
			function route_func(routeCode,routeName)	{
			    ...
			    parent.Entrys.window.location.href="${ROOT}/routeEditPage.do1?routeCode="+routeCode+urlPara;
			...
			function node_func(nodeCode,nodeName){
			    ...
			    parent.Entrys.window.location.href="${ROOT}/nodeEditPage.do1?nodeCode="+nodeCode+urlPara;
			}
			function flow_func(root,flowName){
			    parent.Entrys.window.location.href="${ROOT}/flowEditPage.do1?flowCode="+flowCode+urlPara;
