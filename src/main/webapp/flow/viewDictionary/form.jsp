	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <table class="formtext" border="0" cellpadding="0" cellspacing="1" style="width:98%">
        <tr>
          ...
          <td colspan="3" width="80%"><input name="name" value="${viewDictionary.name }" 
          	style="width:500px;" maxlength="50" showName="名称" check="notBlank;isString('#',100)" class="listinput" required="true"/></td>
		...
		<tr>
          ...
          <td colspan="3">
          	<c:forEach var="o" items="${handleTypewayList}" >
          		<input type="checkbox" name="handleTypeway" value="${o.id }"/>${o.handleWayName }
          	</c:forEach>
          </td>
        </tr>
         <tr>
