...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function deleteFreeFlow(){
		var url = "${ROOT}/deleteFreeFlow.do1?flowCode=<%=request.getParameter("flowCode")%>&boId=<%=request.getParameter("boId")%>&monitorId=<%=request.getParameter("monitorId")%>&batchId=<%=request.getParameter("batchId")%>";
		window.location=url;
	}
	</script>
