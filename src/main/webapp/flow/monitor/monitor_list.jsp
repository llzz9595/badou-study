...
<table width="100%" height="100%"   cellpadding=0 border=0>
      ...
      <tr>
	    ...
	    <tr>
		  <td class="coolButton" align="left" width="3"><img src="${ROOT}/web/flow/img/toolbar.gif"></td>
			<td class="coolButton" onaction="javascript:ev_add()" id="newbtn">新增</td>
			<td class="coolButton" onaction="javascript:ev_update()" id="updatebtn">修改</td>
			<td class="coolButton" onaction="javascript:ev_in()" id="updatebtn">监控</td>
			<td class="coolButton" onaction="javascript:ev_del()" id="deletebtn">删除</td>
  ...
  <tr>
	 	<td width="100%">
		<IFRAME name=listFrame src="${ROOT}/listMonitor.do1" width="100%" height="100%"></IFRAME>
 	</td></tr>
</table>
