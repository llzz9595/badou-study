...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr>
	 	<td width="100%">
		<IFRAME name=listFrame src="${ROOT}/viewFreeFlowMonitor.do1?boId=<%=request.getParameter("boId")%>&delegateId=<%=request.getParameter("delegateId")%>&delegateType=<%=request.getParameter("delegateType")%>&flowCode=<%=request.getParameter("flowCode")%>" width="100%" height="100%"></IFRAME>
 	</td></tr>
</table>
