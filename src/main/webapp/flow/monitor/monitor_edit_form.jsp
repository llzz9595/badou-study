...
if(CheckForm(formFrame.functionForm)){
		formFrame.functionForm.action = "${ROOT}/updateMonitor.do1";
...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr>
	 	<td width="100%">
		<IFRAME name=formFrame src="${ROOT}/editMonitor.do1?isFlowIn=<%=request.getParameter("isFlowIn")%>&id=<%=monitorId%>" width="100%" height="100%"></IFRAME>
 	</td></tr>
</table>
