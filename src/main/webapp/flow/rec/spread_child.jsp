...
function toOpenSpread(nodeCode,id,wid){
	var getview = "${ROOT}/getFlowNodeExt.do1?key=SPREAD_VIEW&id="+nodeCode+"&wid="+wid;
...
function ev_setRead(){
	...
	if(ids!=""){
		var getview = "${ROOT}/setSpreadRead.do1?ids="+ids;
...
<body >
<form name=form2 method="post" action="${ROOT}/querySpread.do1">
