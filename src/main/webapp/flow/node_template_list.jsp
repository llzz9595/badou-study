...
<script type="text/javascript" >
	function ev_new() {
			openWin("${ROOT}/getNodeTemplate.do1?",{showCenter:true,width:750,height:450});
		}
		function ev_edit2(id) {
			openWin("${ROOT}/getNodeTemplate.do1?nodeCode="+id,{showCenter:true,width:750,height:450});
		}
		function ev_edit() {
			var number = 0;
			var checkVal ;
		...
		function ev_del() {
			...
			if(confirm("确定删除所选的记录吗？")){
				...
				document.form1.action="${ROOT}/delNodeTemplate.do1";
