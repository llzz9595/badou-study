...
function ev_turn()
{
	if(getselect()==0)
	{
		alert("您没有选择要回收的记录！");return;
	}
	form1.action="${ROOT}/updateUndoByAccreditOn.do1";
	form1.submit();
}
...
<br>
<div align="center"><input type="button" class="button" value="回收" onclick="javascript:ev_turn();">
