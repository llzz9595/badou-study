...
function ev_save()
{
	...
	if (method=="update")
	{
		formFrame.accreditForm.action="/updateAccredit.do1?";
	}
	if (method=="add")
	{
		formFrame.accreditForm.action="/createAccredit.do1?";
	}
...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr><td>
   <iframe scrolling="auto"   src="/viewAccredit.do1?method=<%=request.getParameter("method")%>&accreditID=<%=request.getParameter("accreditID")%>"
