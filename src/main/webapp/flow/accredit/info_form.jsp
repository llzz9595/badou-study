...
function ev_save()
{
	...
	if (method=="update")
	{
		formFrame.infoForm.action="/updateInfo.do1";
	}
	if (method=="add")
	{
		formFrame.infoForm.action="/createInfo.do1";
	}
...
<table width="100%" height="100%"   cellpadding=0 border=0>
  ...
  <tr><td>
   <iframe scrolling="auto"   src="/editInfo.do1?method=<%=request.getParameter("method")%>&infoID=<%=request.getParameter("infoID")%>"
