...
<script language="javascript">
 function self_off(){
 	location.href="/listSelfOffAccredit.do1";
 }
 function self_on(){
 	location.href="/listSelfOnAccredit.do1";
 }
 function self_receive(){
 	location.href="/listSelfReceiveAccredit.do1";
 }
</script>
 <script language="javaScript">
    var n = 0;
   ...
   var selected=new Array();
    ...
    if (count >0)  {
      if (window.confirm("您确认要删除记录？")) {
	     ...
	     accreditForm.action = "/deleteSelfAccredit.do1";
         accreditForm.submit();
      }
    }else {
       alert("您还没选择记录!");
   ...
   var selected=new Array();
    ...
    if (count >0)  {
      if (window.confirm("您确认要启动该授权？")) {
      	 accreditForm.target="_self";
	     accreditForm.action = "/onSelfAccredit.do1";
         accreditForm.submit();
      }
    }else {
       alert("您还没选择记录!");
   ...
   var selected=new Array();
    ...
    if (count >0)  {
      if (window.confirm("您确认要停止该授权？")) {
      	 accreditForm.target="_self";
	     accreditForm.action = "/offSelfAccredit.do1";
         accreditForm.submit();
      }
    }else {
       alert("您还没选择记录!");
...
function ev_log()
{
	location.href="${ROOT}/listSelfAllAccredit.do1";
}
