...
entrysUri = request.getContextPath()+"/listFlowPage.do1?"+urlPara;
treeUri = request.getContextPath()+"/listFlowTree.do1?flowCode="+flowCode+urlPara;
}else{
entrysUri = request.getContextPath()+"/flowEditPage.do1?flowCode="+flowCode+urlPara;
treeUri = request.getContextPath()+"/listFlowTree.do1?flowCode="+flowCode+urlPara;
}
%>
