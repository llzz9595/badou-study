  ...
  <link href="${ROOT}/css/layout.css" rel="stylesheet" type="text/css" />
  	...
  	<!--
  		...
  		function ev_back(type){
  			if(type=='0')
  				var url = "${ROOT}/viewRoleResource.do1?id=${role.parent.id }";
  			else
  				var url = "${ROOT}/viewRoleResource.do1?id=${role.id }";
...
<form name="form" action="${ROOT}/saveRole.do1" method="post" id="form">
...
<table width="100%" class="formtext1" border="0" cellpadding="0" cellspacing="1">
  ...
  <tr> 
	...
	<td width="70%">
		...
		<a href="#" onclick="getAddressList('0','n','3','scopesName','scopes');return false;" class="choose">选择</a> 
	</td>	
  </tr>
  <tr> 
  	<td height="22" width="30%" class="t">我的主页URL</td>
	<td width="70%">
		<input type="text" name="indexUrl" id="indexUrl" class="editline" maxlength="100" size="30" value="${role.indexUrl}" /> 
	</td>	
	</tr>
	  <tr> 
	...
	<td width="70%">
		<textarea rows="4" cols="50" id="remark" name="remark">${role.remark }</textarea>
	</td>
  </tr> 
</table>
</form>
