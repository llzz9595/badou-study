...
%>
	...
	actionArray[0] = "${ROOT}/queryPersonAssessment.do1";
	actionArray[1] = "${ROOT}/reportA.do1";
	function  onInit()
	{
	...
	function saveQuery()
	{
	    ...
	    if(CheckForm(form1)&&reportFrame.checkForm2()){
           ...
           if(!(info2.length>1))
    	   {
			...
			form1.action="${ROOT}/savePersonQuery.do1";	
			form1.submit();
		}
		
	    // queryObject = 
	   //  query_in();
	 //  var url = "${ROOT}/createFavorite.do1?favoriteInfo="+encodeURI(outputValue)+"&parentId="+retArray[1];
	...
	*/
	...
	function exit2()
	{
	  form1.action="${ROOT}/listPersonQuery.do1";	
	  form1.submit();
	}
	</script>
</head>
