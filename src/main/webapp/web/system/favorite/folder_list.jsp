  ...
  <head>
	...
	<!--
	    function ev_showDate(parentId)
	    {
	       ...
	       this.location.href="${ROOT}/listFolderData.do1?id="+parentId;
	    }
		/**
		*新增部门
		*/
		function ev_add(parentId){
			var url = "${ROOT}/createPersonFolder.do1?parentId="+parentId;
		...
		*/
		...
		function ev_edit2(id) {
			var url = "${ROOT}/editPersonFolder.do1?id="+id;
			//openFullScreenWin(url);
			pageShowForm(url);
		}
		/**
		...
		*/
		function ev_delete(){
			...
			if(confirm("确定删除所选的记录吗？")){
				document.form1.action="${ROOT}/delPersonFolder.do1";
		   ...
		   // alert("parentId:"+parentId);
		    ...
		    if(retvalue!=null&&retvalue!="")
		    {
		       ...
		       // alert("retvalue:"+retvalue);
		        document.form1.action="${ROOT}/movePersonFolder.do1?targetid="+retvalue;
				document.form1.submit();	
		    }
		     return ;
		}
		...
		{
			var url = "${ROOT}/swapPersonFolder.do1?currId="+currId+"&swapId="+swapId+"&parentId="+parentId;
			window.location = url;
		}
