...
<body  class="main-body" >
	...
	<tr>
	  ...
	  <td height="288"  width="88%" >
		...
		<iframe id="ftree" src="${ROOT}/treePersonFolder.do1?jsFunc=list_folder&listType=favorite"  scrolling="auto"  frameborder="0" name="ftree" width="100%" height="100%"></iframe>
        </div>
	  </td>
	<tr>
	</table>
