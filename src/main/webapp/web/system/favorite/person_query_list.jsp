...
<html>
  <head>
	...
	<!--
		...
		*/
		function ev_add(){
			var url = "${ROOT}/createPersonQuery.do1";
		...
		*/
		...
		function ev_edit2(id) {
			var url = "${ROOT}/editPersonQuery.do1?id="+id;
		...
		*/
		function ev_delete(){
			...
			if(confirm("确定删除所选的记录吗？")){
				document.form1.action="${ROOT}/delPersonQuery.do1";
				document.form1.submit();
			}	
		}
		...
		{
		   //alert("oo");
			var url = "${ROOT}/swapPersonQuery.do1?currId="+currId+"&swapId="+swapId;
			window.location = url;
		}
