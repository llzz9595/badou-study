			     ...
			     //  alert("list_folder");
				  ...
				  //alert("listType"+listType);
					...
					if(listType=="folder")
					{
					  ...
					  pageShowList('${ROOT}/listPersonFolder.do1?id='+targetTypeID);
					}
					else if(listType=="data")
					{
					  pageShowList('${ROOT}/listFolderData.do1?id='+targetTypeID);
					}
					...
					{ //用于我的收藏夹的显示
					  // parent.parent.fbody.fbody.location.href='${ROOT}/listAddrFolderData.do1?id='+targetTypeID;
