	...
	<!--
		...
		*/
		function ev_add(orgId){
			var url = "${ROOT}/createGroup.do1?orgId="+orgId;
			pageShowForm(url);
		}
		...
		*/
		function ev_edit(id){
			var url = "${ROOT}/editGroup.do1?id="+id;
			pageShowForm(url);
		}
		...
		*/
		function ev_delete(orgId){
			...
			if(confirm("确定要删除选定的群组吗?")){
				...
				form.action = "${ROOT}/delGroup.do1?orgId="+orgId;
				form.submit();
			}
		}
	//-->
...
<div align="left">
	  ...
	  <table class="list-box" cellspacing="0" rules="all"  border="0" >
		...
		<tr class="list-color${idx.index%2==0?'1':'2' }">
		  ...
		  <td class="list-text1" >
		  		<a href="${ROOT}/getDetails.do1?id=${group.id  }">查看群组成员</a>
		  </td>
		</tr>
		</c:forEach>
	</table>
