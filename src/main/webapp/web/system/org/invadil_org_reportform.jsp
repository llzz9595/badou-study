...
<!--
		function query(){
			...
			if(CheckForm(form)){
				form.action="${ROOT}/invadilOrgReporter.do1";
    	      	form.target="_blank"; 
    	      	form.submit();
			}
		}
...
<body onmousewheel="setScrollzheight()" class="LN_body">
      ...
      <form name="form1" method="post" action="" id="form1">
       <input name="orgInfo" type="hidden" value="${orgInfo}" id="orgInfo"/>
        ...
        <textarea cols="65" rows="3" class="textarea1" name="orgName" id="orgName" readonly="true">${orgName}</textarea>	</td>
        ...
        <td>查询方式:</td>
        <td>
        	<input type="radio" name="queryType" value="0" checked/>组织所有子组织&nbsp;&nbsp;
        	<input type="radio" name="queryType" value="1" />组织直属子组织&nbsp;&nbsp;
        </td>
