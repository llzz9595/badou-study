...
<jsp:directive.page import="com.shengdai.kpi.system.security.SecurityHelper"/>
<jsp:directive.page import="com.shengdai.kpi.system.security.Security"/>
<jsp:directive.page import="com.shengdai.kpi.system.OrgType"/>
<%
	...
	String currentMenu = tmpManage[0];
					...
					<table height="100%" width="100%" border="0" cellspacing="0"
						...
						<script language="javascript">
							...
							function showMyFavorite(){
								if(!showFavorite){
									showFavorite = true;
									mapFrame13.location.href="treePersonData.do1?jsFunc=list_folder&listType=addr&"+Math.random();
								}
							}
						</script>
						<!-- 一级菜单 收藏夹 -->
						...
						<script language="javascript">
							...
							function showMyGroup(){
								if(!loadedMyGroup){
									loadedMyGroup = true;
									mapFrame1.location.href="<%=request.getContextPath()%>/org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=1&"+Math.random();
								}
							}
							...
							function showAllOrg(){
								if(!allOrg){
									...
									<%
 									...
 									%>
									mapFrame3.location.href="<%=request.getContextPath()%>/org_addressTree.do1?jsFunc=select_org_by_type<%=scopeNum==1?"&myOrg=2":""%>&type=<%=type%>&"+Math.random();
							...
							//		loadedFavorite = true;
							//		favoriteFrm.location.href="org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=1&"+Math.random();
							//	}
							//}
						...
						<script language="javascript">
							...
							function showMyGroup(){
								if(!loadedMyGroup){
									loadedMyGroup = true;
									mapFrame4.location.href="<%=request.getContextPath()%>/scopeAddress.do1?jsFunc=openRight&type=<%=type%>&"+Math.random();
								}
							}
						...
						<script language="javascript">
							...
							function showSpecGroup(){
								if(!specGroup){
									specGroup = true;
									url="org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=3&oids=<%=ParamUtils.getParameter(request, "oids","0")%>&"+Math.random();
						...
						<script language="javascript">
								...
								function getroleAddress(){
									...
									if(!myCompany){
										myCompany = true;
										mapFrame8.location.href="<%=request.getContextPath()%>/org_addressTree.do1?jsFunc=select_org_by_type<%=scopeNum==1?"&myOrg=2":""%>&type=<%=type%>&"+Math.random();
									}
								}
						...
						<script language="javascript">
								...
								function getroleAddress(){
									if(!myCompany){
										myCompany = true;
										mapFrame10.location.href="org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=2&"+Math.random();
									}
								}
						...
						<script language="javascript">
								...
								function getMyOrgAddress(){
									if(!myGroup_1){
										myGroup_1 = true;
										mapFrame9.location.href="org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=1&"+Math.random();
									}
								}
						...
						<script language="javascript">
								...
								function getAllAddress(){
									mapFrame11.location.href="org_addressTree.do1?jsFunc=select_org_by_type&type=<%=type%>&myOrg=0&"+Math.random();
								}
						...
						<script language="javascript">
								...
								function getroleAddress(){
									if(!roleAddress){
										roleAddress = true;
										mapFrame7.location.href="addressTreeRole.do1?jsFunc=listResource&"+Math.random();
									}
								}
						...
						<script language="javascript">
							...
							function getUniformPosTreeForAddress(){
								if(!uniformPosTreeForAddress){
									...
									mapFrame6.location.href="uniformPosTreeForAddress.do1?jsFunc=list_uniform&"+Math.random();
								}
							}
						...
						<script language="javascript">
								...
								function getLineTreeForAddress(){
									if(!lineTreeForAddress){
										...
										mapFrame5.location.href="lineTreeForAddress.do1?jsFunc=list_uniform&"+Math.random();
									}
								}
						...
						<tr id="menu_25"
							onClick="SwitchSubMenu(this);getAreaTreeForAddress();"
							style="CURSOR: hand" align="center">
							<td height="24" width="200" align="center" valign="middle"
								style="background-image:url(<%=request.getContextPath()%>/img/menu3.gif);background-repeat:no-repeat"
								colspan="2">
							...
							<td height="100%" valign="top" align="center" width="100%">
								<div
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<tr>
											<td id="menu_td" align="center" height=100% width="100%">
												<iframe width=100% height=100% name="mapFrame25"></iframe>
											</td>
										</tr>
										<tr>
											<td height="100%">
						...
						<script language="javascript">
								//区域
								var areaTreeForAddress=false;
								function getAreaTreeForAddress(){
									if(!areaTreeForAddress){
										areaTreeForAddress = true;
										mapFrame25.location.href="<%=request.getContextPath()%>/custom/area/treeaddressbook/enter.do?"+Math.random();
									}
								}
								//window.onload=getLineTreeForAddress;
...
<script language="javascript">
	...
	var idx = <%=currentMenu%>;
	if(idx==0) idx = 4;
	document.getElementById("menu_"+idx).click();
	}catch(e){}
</script>
	</body>
</html>
