				...
				<table width="78%" height="70%" border="1" align="center"
					...
					<tr>
						<td width="45%" valign="top">
							<iframe src="${ROOT}/uniformTree.do1?jsFunc=select_type&multi=${param.multi}&type=${param.type }"  style="width:195px;height:275px" id="fbody" scrolling="no" frameborder="0" name="fbody" width="100%" height="100%"></iframe>
						</td>
