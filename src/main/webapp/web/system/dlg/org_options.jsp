...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin:0px;padding:0px;">
		<form METHOD="post"  action="" name="optionAction" id="optionAction">
			...
			<select name="orgOptions" id="orgOptions" multiple size="16" style="width:240px;height:325px;" 
				onchange="setRemark();"  onDblclick="selectItem();" >
			<c:forEach var="o" items="${list}">
				<c:set var='bgColor' value='fontcolor${o.type.intValue}' />
				<option value="${o.parseAddressInfo}" remark="${o.infoInAddressBook }" datas="${o.appendDatas}" class="${bgColor}">
					${o.name}
				</option>
			</c:forEach>
			</select>
