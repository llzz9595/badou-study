...
function createButton(el) {
	...
	el.setVisibled	= createButton.setVisibled;
	el.getVisibled	= createButton.getVisibled;
	...
	el.setOnaction	= createButton.setOnaction;
	el.getOnaction	= createButton.getOnaction;

	el.setCaption	= createButton.setCaption;
	el.getCaption	= createButton.getCaption;
...
createButton.clickCoolButton = function () {
 	var el = createButton.getParentCoolButton(window.event.srcElement);
	//el.onaction = el.getAttribute("onaction");   //yuechun
...
createButton.setVisibled = function (b) {
	if (this._visibled != b) {
		this._visibled = b;
		createButton.setClassName(this, false, false);
		if (!window.moz) {
...
createButton.getVisibled = function () {
	return this._visibled;
};

createButton.setOnaction = function (b) {
  this.onaction= b ;
};

createButton.getOnaction = function () {
	return this.onaction;
};

createButton.setCaption = function (b) {
  this.caption= b ;
  this.innerHTML = b;
};

createButton.getCaption = function () {
	return this.caption;
};