...
<jsp:directive.page import="com.shengdai.kpi.attach.AttachConfig"/>
...
<body class="LN_body">
<form action="${ROOT}/uploadFile.do1"  method="post" enctype="multipart/form-data" name="UploadForm" target="uploadWin">
...
<div class="LN_colorRed">当附件名为空时，自动将名称等同于上传文件的名称.</div>
