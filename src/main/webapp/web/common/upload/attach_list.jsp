	       ...
	       <table width="100%" border="0" cellspacing="1" cellpadding="0" class="LN_tableBox2">
	        ...
	        <td class="LN_tableBoxtitle2">操作</td>
		      ...
		      <tr class="list-color${idx.index%2==0?'1':'2'}" id="${o.id}">
		        ...
		        <td class="LN_tableBoxText2"><a href="javascript:window.location='${ROOT}/downloadFile.do1?id=${o.id}';" class="LN_BlueLink" >${o.name}&nbsp;</a></td>
		        ...
		        <td class="LN_tableBoxText2">
		            ...
		            onclick="window.location='${ROOT}/downloadFile.do1?id=${o.id}'"/></td>
		      </tr>
		      </c:forEach>
		      </tbody>
	       </table>
