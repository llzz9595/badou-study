...
var webFXTreeConfig = {
	rootIcon        : '../../common/xtree/images/foldericon.png',
	openRootIcon    : '../../common/xtree/images/openfoldericon.png',
	folderIcon      : '../../common/xtree/images/foldericon.png',
	openFolderIcon  : '../../common/xtree/images/openfoldericon.png',
	fileIcon        : '../../common/xtree/images/file.png',
	fileIcon2        : '../../common/xtree/images/file.gif',
	iIcon           : '../../common/xtree/images/I.png',
	lIcon           : '../../common/xtree/images/L.png',
	lMinusIcon      : '../../common/xtree/images/Lminus.png',
	lPlusIcon       : '../../common/xtree/images/Lplus.png',
	tIcon           : '../../common/xtree/images/T.png',
	tMinusIcon      : '../../common/xtree/images/Tminus.png',
	tPlusIcon       : '../../common/xtree/images/Tplus.png',
	blankIcon       : '../../common/xtree/images/blank.png',
...
function WebFXTreeAbstractNode(sText,sPre, sAction) {
	this.childNodes  = [];
	this.pre = "";
...
function WebFXTree(sPre,sText, sAction, sBehavior, sIcon, sOpenIcon) {
	this.base = WebFXTreeAbstractNode;
	this.base(sPre,sText, sAction);
...
WebFXTree.prototype.toString = function() {
	...
	str += "<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">"+this.pre+"<a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\">" + this.text + "</a></div>";
...
function WebFXTreeItem(sPre,sText, sAction, eParent, sIcon, sOpenIcon) {
	this.base = WebFXTreeAbstractNode;
	this.base(sPre,sText, sAction);
	/* Defaults to close */
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	str += "<img id=\"" + this.id + "-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">"+this.pre+"<a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\">" + label + "</a></div>";
	str += "<div id=\"" + this.id + "-cont\" class=\"webfx-tree-container\" style=\"display: " + ((this.open)?'block':'none') + ";\">";
	for (var i = 0; i < this.childNodes.length; i++) {
		str += this.childNodes[i].toString(i,this.childNodes.length);
	}
