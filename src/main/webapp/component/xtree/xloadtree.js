...
webFXTreeConfig.emptyErrorTextTemplate = "没有子节点";
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon, checkboxName, nodeId) {

	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, null, null, checkboxName, nodeId);
...
function _xmlTreeToJsTree(oNode) {
	...
	var checkboxName = oNode.getAttribute("checkboxName");
	var nodeId = oNode.getAttribute("id");

	// create jsNode
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, parent, icon, openIcon, checkboxName, nodeId);
	else
		jsNode = new WebFXTreeItem(text, action, parent, icon, openIcon, null, null, checkboxName, nodeId);
