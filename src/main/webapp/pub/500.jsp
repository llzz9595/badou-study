...
<!-- Override section - For ssl errors only.  Removed on init for other error types.  -->
     <button id="errorTryAgain" autocomplete="off"  style="margin-top:10px" class="l-button l-button-submit"  onclick="retryThis();" autofocus="true">重试</button>
     <button  id="btnClose" autocomplete="off" style="margin-top:10px;margin-right:10px" class="l-button l-button-submit"  autofocus="false">关闭</button><!--
   
     
     <button id="btnClose"autocomplete="off" style="margin-top:10px"  class="l-button l-button-submit" >关闭</button>
--></div>
