...
function openWin(url,options) {
	...
	if(options == null) {
	    ...
	    if(document.all)
	    {
			strOptions += "scrollbars=yes,resize=yes";
...
function setPHeight3(){
	...
	if(parent.document.all["divTree"] != undefined && parent.document.all["ftree"].style != undefined){
		parent.document.all["divTree"].style.height = temp+50;
		parent.document.all["ftree"].style.height = temp+50;
		 parent.document.all["ftree"].height = temp+50;
	}
	if(parent.document.all["divList"] != undefined && parent.document.all["fbody"].style != undefined){
		parent.document.all["divList"].style.height = temp+50;
		parent.document.all["fbody"].style.height = temp+50;
		parent.document.all["fbody"].height = temp+50;
	} 
	if(parent.document.all["divForm"] != undefined && parent.document.all["fform"].style != undefined){
		parent.document.all["divForm"].style.height = temp+50;
		parent.document.all["fform"].style.height = temp+50;
		parent.document.all["fform"].height = temp+50;
	}
